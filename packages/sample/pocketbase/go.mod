...
require github.com/benallfree/pbscript/modules/pbscript v0.0.1
...
require (
	...
	github.com/pocketbase/pocketbase v0.7.5 // indirect
...
//replace github.com/benallfree/pbscript/modules/pbscript v0.0.1 => ../../modules/pbscript
